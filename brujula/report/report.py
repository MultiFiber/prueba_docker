...
from django.http import HttpResponseBadRequest, HttpResponse, HttpResponseServerError, FileResponse
...
def report(request, report_type, data):
    ...
    try:
        ...
        response = FileResponse(io.BytesIO(pdf_report), as_attachment=False, filename='albums.pdf')
        print(response)
        return response
